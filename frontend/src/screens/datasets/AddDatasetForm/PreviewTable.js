...
// Removed AddIcon and RAButton as they are no longer needed for the manual button
    ...
    const columns = [
        {
            ...
            width: 50,
            align: 'center',
            Cell: ({ row }) => <RATypography variant="caption">{row.index + 1}</RATypography>,
        },
        {
            Header: 'Name',
            accessor: 'field',
        ...
        },
        {
            ...
            Cell: ({ row }) => {
                ...
                return (
                    ...
                    >
                        {vals.length > 0 ? vals.join(', ') : <span style={{color:'#ccc'}}>-</span>}
                    </RABox>
                );
            },
        },
